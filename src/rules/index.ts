...
import { resourceSubscriptions } from './resource-subscriptions.js';
...
export const RULES: readonly Rule[] = [sdkV1Package, statefulHandshake, removedMethods, resourceSubscriptions, errorCodes];
